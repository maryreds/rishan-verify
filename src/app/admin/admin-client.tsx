  ...
  async function approveVerification(request: VerificationRequest) {
    ...
    try {
      ...
      await supabase.from("audit_log").insert({
        ...
        target_type: "verification_request",
        target_id: request.id,
        metadata: { immigration_status: reviewForm.immigration_status },
      });
                      ...
                      <div className="flex gap-2">
                        {req.document_path && (
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              viewDocument(req.id, req.document_path!)
                            }
                          >
                        ...
                        <div className="space-y-4">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2">
                              ...
                              >
                                ...
                                <SelectContent>
                                  <SelectItem value="US Citizen">
                                    US Citizen
                                  </SelectItem>
                                  <SelectItem value="Green Card">
                                    Green Card / Permanent Resident
                                  </SelectItem>
                                  <SelectItem value="H-1B">
                                    H-1B Visa
                                  </SelectItem>
                                  <SelectItem value="H-4 EAD">
                                    H-4 EAD
                                  </SelectItem>
                                  <SelectItem value="L-1">L-1 Visa</SelectItem>
                                  <SelectItem value="L-2 EAD">
                                    L-2 EAD
                                  </SelectItem>
                                  <SelectItem value="F-1 OPT">
                                    F-1 OPT
                                  </SelectItem>
                                  <SelectItem value="F-1 CPT">
                                    F-1 CPT
                                  </SelectItem>
                                  <SelectItem value="F-1 STEM OPT">
                                    F-1 STEM OPT Extension
                                  </SelectItem>
                                  <SelectItem value="TN Visa">
                                    TN Visa
                                  </SelectItem>
                                  <SelectItem value="E-3">E-3 Visa</SelectItem>
                                  <SelectItem value="O-1">O-1 Visa</SelectItem>
                                  <SelectItem value="EAD Other">
                                    EAD (Other)
                                  </SelectItem>
                                </SelectContent>
                              </Select>
                          ...
                          <div className="flex gap-3">
                            <Button
                              ...
                              disabled={
                                !reviewForm.immigration_status || processing
                              }
            ...
            <div className="space-y-1">
              {completedRequests.map((req, idx) => (
                <div key={req.id}>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      {req.status === "completed" ? (
                        <span className="flex items-center gap-1 text-emerald-600 dark:text-emerald-400 text-xs font-medium">
                          <CircleCheckBig className="h-3.5 w-3.5" /> Approved
                        </span>
                      ) : (
                  ...
                  {idx < completedRequests.length - 1 && <Separator />}
                </div>
              ))}
            </div>
          )}
